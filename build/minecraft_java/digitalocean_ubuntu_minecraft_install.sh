...
# $4 ms_memory_mb="1024"
# $5 mx_memory_mb="1024"
# $6 forge_url="https://files.minecraftforge.net/maven/net/minecraftforge/forge/1.13.2-25.0.209/forge-1.13.2-25.0.209-installer.jar"
#. ./setup_params_minecraft_install
if [ -n "$3" ]; then forge_version=$3; fi
if [ -n "$4" ]; then ms_memory_mb=$4; fi
if [ -n "$5" ]; then mx_memory_mb=$5; fi
if [ -n "$6" ]; then forge_url=$6; fi
